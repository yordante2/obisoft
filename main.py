...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        try:
            tl_admin_user = os.environ("os.ADMIN")
        except:
            tl_admin_user = os.environ.get("os.ADMIN")
        print(f'Administrador: @{tl_admin_user}')
        ...
        if '/start' in msgText:
            ...
            bot.editMessageText(message,'Comando No Válido')
    except Exception as ex:
           print(str(ex))
...
def main():
    ...
    print('Bot iniciado')
    try:
        bot_token = os.environ("os.TOKEN")
    except:
        bot_token = os.environ.get("os.TOKEN")
